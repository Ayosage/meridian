...
export type CatanEvent =
  | { kind: 'roll'; player: number; dice: readonly [number, number]; total: number; gains: Readonly<Record<number, ResourceMap>>; robbed?: readonly Resource[]; denied?: readonly Resource[] }
